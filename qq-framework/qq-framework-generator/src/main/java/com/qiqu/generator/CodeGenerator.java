...
public class CodeGenerator {
    ...
    private static final String javaPath = System.getProperty("user.dir") + "/"
            + "qq-model-" + SERVICE_NAME + "/"
            + "qq-" + SERVICE_NAME + "-service" + "/"
            + "src/main/java";
    ...
    private static final DataSourceConfig DATA_SOURCE_CONFIG = new DataSourceConfig
            .Builder("jdbc:mysql://152.32.252.204:3306/qq-" + SERVICE_NAME + "?useUnicode=true&useSSL=false&characterEncoding=utf8"
            , "root", "ofo12441200").build();
